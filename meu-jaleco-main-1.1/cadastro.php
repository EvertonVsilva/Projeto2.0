    ...
    <div class="container">
        ...
        <form
            ...
            <div class="col-md-4">
                ...
                <input type="tel" class="form-control" id="campo_telefone_celular" name="telefone_celular" placeholder="(+55)XX-XXXXXXXX" required maxlength="17">
                <div class="invalid-feedback" id="feedback_celular">
                    O Celular é obrigatório e deve ter o formato (+55)XX-XXXXXXXX.
                </div>
            </div>

            <div class="col-md-4">
                <label for="campo_telefone_fixo" class="form-label">Telefone Fixo</label>
                <input type="tel" class="form-control" id="campo_telefone_fixo" name="telefone_fixo" placeholder="(+55)XX-XXXXXXXX" required maxlength="17">
                <div class="invalid-feedback" id="feedback_fixo">
                    O Fixo é obrigatório e deve ter o formato (+55)XX-XXXXXXXX.
                </div>
            </div>
