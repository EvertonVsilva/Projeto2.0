    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="menu-navegacao">
            <ul class="navbar-nav mb-2 mb-lg-0 text-center mx-auto">
                ...
                <li class="nav-item mt-2 d-lg-none">
                    <?php if ($logado): ?>
                        ...
                        <a href="/meu-jaleco-main/perfil.php" class="nav-link btn btn-outline-light text-center mt-1">
                ...
                <li class="nav-item mb-2 d-lg-none">
                    <div class="d-flex justify-content-center gap-2">
                        <button id="botao-diminuir-fonte-mobile" class="btn btn-dark">
                            <i class="bi bi-dash-circle"></i> A-
                        </button>
                        <button id="botao-aumentar-fonte-mobile" class="btn btn-dark">
            ...
            <div class="d-none d-lg-flex ms-auto align-items-center">
                <?php if ($logado): ?>
                    ...
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownPerfil">
                            <li>
                                <a class="dropdown-item" href="/meu-jaleco-main/perfil.php">
                                    <i class="bi bi-person-fill"></i> Meu Perfil
                                </a>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item text-danger" href="/meu-jaleco-main/logout.php">
                ...
                <button id="botao-diminuir-fonte" class="btn btn-dark me-1" title="Diminuir fonte">
                    <i class="bi bi-dash-circle"></i>
                </button>
                <button id="botao-aumentar-fonte" class="btn btn-dark me-2" title="Aumentar fonte">
